...
/********************************************************************************************/
/*!
	 \brief	 This function enables clock for ADC

	 \param[in] receives adc name
	 \return void
 */
...
/********************************************************************************************/
/*!
	 \brief	 This selects configures starus and control

	 \param[in] receives adc name, channel set, and config
	 \return void
 */
...
/********************************************************************************************/
/*!
	 \brief	 This selects configures ADC

	 \param[in] receives adc name and config
	 \return void
 */
...
/********************************************************************************************/
/*!
	 \brief	 This enables irq conversion

	 \param[in] receives adc name and channel
	 \return void
 */
...
/********************************************************************************************/
/*!
	 \brief	 This disables irq conversion
...
/********************************************************************************************/
/*!
	 \brief	 This gets adc conversion flag
